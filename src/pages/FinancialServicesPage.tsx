      ...
      <section className="relative bg-brand-slate/5 py-16 md:py-24 border-b border-brand-slate/10 overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none select-none">
          <img
            src={logoUrl}
            alt=""
            className="absolute -top-16 -left-16 w-[700px] aspect-[2/1] object-cover object-center opacity-[0.04] -rotate-12 grayscale scale-75"
          />
          <img
            src={logoUrl}
            alt=""
            className="absolute top-0 right-0 w-[500px] aspect-[2/1] object-cover object-center opacity-[0.04] rotate-45 grayscale scale-75"
          />
        </div>
