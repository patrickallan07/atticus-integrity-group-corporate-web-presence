        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-display text-brand-navy mb-6">
              Atticus Integrity <span className="text-brand-gold">Financial</span>
            </h1>
            ...
            {financialServices.map((service, idx) => (
              ...
              >
                <Card className="h-full hover:-translate-y-1 hover:shadow-xl transition-all duration-300 border-slate-200">
                  <CardHeader>
                    <div className="h-12 w-12 bg-brand-gold/10 rounded-lg flex items-center justify-center text-brand-gold mb-2">
