      ...
      <section className="relative min-h-[85vh] flex items-center bg-brand-cream overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none select-none">
          <img
            src={logoUrl}
            alt=""
            className="absolute -top-10 -right-20 w-[800px] aspect-[2/1] object-cover object-center opacity-[0.04] rotate-12 grayscale scale-110"
          />
          <img
            src={logoUrl}
            alt=""
            className="absolute -bottom-20 -left-20 w-[1000px] aspect-[2/1] object-cover object-center opacity-[0.04] -rotate-12 grayscale scale-110"
          />
        </div>
